...
function jasonTravel() {
  return [
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-06-10", data: { title: "Barcelona & Costa Brava", city: "Barcelona", country: "Spain", startDate: "2025-06-10", endDate: "2025-06-18", snapshot1: "La Sagrada Familia took my breath away — Gaudi was a genius", snapshot2: "Swimming in hidden coves along the Costa Brava", travelTips: "Book Sagrada Familia tickets 2 months early. Rent a car for Costa Brava day trips.", rating: 5, visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-03-15", data: { title: "Tokyo & Kyoto", city: "Tokyo", country: "Japan", startDate: "2025-03-15", endDate: "2025-03-25", snapshot1: "Cherry blossoms in Shinjuku Gyoen — timing was perfect", snapshot2: "The Fushimi Inari gates at sunrise with no one around", snapshot3: "Ramen in Golden Gai at 2am", travelTips: "Get a 7-day JR pass. Stay in Shinjuku for access.", rating: 5, visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2024-12-20", data: { title: "Iceland Ring Road", city: "Reykjavik", country: "Iceland", startDate: "2024-12-20", endDate: "2024-12-30", snapshot1: "Northern lights dancing over the glacier lagoon", snapshot2: "Driving through whiteout snowstorms was terrifying and beautiful", rating: 5, visibilityRings: [1, 2] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-09-01", data: { title: "Amalfi Coast Road Trip", city: "Positano", country: "Italy", startDate: "2025-09-01", endDate: "2025-09-08", snapshot1: "Limoncello on the terrace overlooking the sea at sunset", travelTips: "Drive the coast early morning — no traffic, no buses.", rating: 5, visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-01-05", data: { title: "Skiing in Chamonix", city: "Chamonix", country: "France", startDate: "2025-01-05", endDate: "2025-01-12", snapshot1: "The Vallée Blanche descent was a once-in-a-lifetime run", rating: 4, visibilityRings: [4] } },
    { id: crypto.randomUUID(), category: "travel", status: "wishlist", data: { title: "Patagonia Trekking", city: "El Chaltén", country: "Argentina", wishlistReason: "W Trek + Fitz Roy — the ultimate hiking trip", visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "wishlist", data: { title: "New Zealand South Island", city: "Queenstown", country: "New Zealand", wishlistReason: "Milford Sound, glaciers, LOTR locations", visibilityRings: [1, 2, 3, 4] } },
  ];
}

function sarahTravel() {
  return [
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-05-20", data: { title: "Paris in Spring", city: "Paris", country: "France", startDate: "2025-05-20", endDate: "2025-05-27", snapshot1: "Picnic under the Eiffel Tower at golden hour", snapshot2: "The Musée d'Orsay impressionist collection left me speechless", snapshot3: "Croissants from Du Pain et des Idées every morning", travelTips: "Stay in Le Marais. Museum pass is worth it.", rating: 5, visibilityRings: [1, 2] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-08-15", data: { title: "Santorini & Athens", city: "Santorini", country: "Greece", startDate: "2025-08-15", endDate: "2025-08-23", snapshot1: "Watching the sunset from Oia was everything I imagined", snapshot2: "Swimming in the caldera — surreal blue water", rating: 5, visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-02-14", data: { title: "Tulum & Cenotes", city: "Tulum", country: "Mexico", startDate: "2025-02-14", endDate: "2025-02-20", snapshot1: "Swimming in Gran Cenote was magical — the light beams through the cave", travelTips: "Rent bikes. Go to cenotes at 8am to beat crowds.", rating: 4, visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-10-10", data: { title: "Morocco — Marrakech to Sahara", city: "Marrakech", country: "Morocco", startDate: "2025-10-10", endDate: "2025-10-18", snapshot1: "Sleeping under the stars in the Sahara desert", snapshot2: "The colors and chaos of Jemaa el-Fnaa at night", rating: 5, visibilityRings: [1, 2, 3] } },
    { id: crypto.randomUUID(), category: "travel", status: "wishlist", data: { title: "Bali & Ubud", city: "Ubud", country: "Indonesia", wishlistReason: "Rice terraces, temples, yoga retreats", visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "wishlist", data: { title: "Northern Japan in Autumn", city: "Nikko", country: "Japan", wishlistReason: "Fall foliage at temples, onsen culture", visibilityRings: [1, 2, 3, 4] } },
  ];
}

function mikeTravel() {
  return [
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-04-01", data: { title: "Patagonia — Torres del Paine", city: "El Chaltén", country: "Argentina", startDate: "2025-04-01", endDate: "2025-04-12", snapshot1: "Seeing Fitz Roy emerge from the clouds after 3 days of rain", snapshot2: "The W Trek is the hardest and best thing I've ever done", snapshot3: "Mate with gauchos at a remote estancia", travelTips: "Book refugios 6 months ahead. Layers are everything.", rating: 5, visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-07-20", data: { title: "Swiss Alps — Zermatt & Grindelwald", city: "Zermatt", country: "Switzerland", startDate: "2025-07-20", endDate: "2025-07-28", snapshot1: "The Matterhorn at sunrise from Gornergrat — worth the 5am alarm", snapshot2: "Paragliding over Interlaken was pure freedom", rating: 5, visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-01-15", data: { title: "Costa Rica Adventure", city: "La Fortuna", country: "Costa Rica", startDate: "2025-01-15", endDate: "2025-01-22", snapshot1: "Zip-lining through the cloud forest canopy", travelTips: "4x4 essential. Dry season (Jan-Apr) is best.", rating: 4, visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "visited", start_date: "2025-11-05", data: { title: "Vietnam — Hanoi to Ho Chi Minh", city: "Hanoi", country: "Vietnam", startDate: "2025-11-05", endDate: "2025-11-16", snapshot1: "Motorbike through Ha Giang Loop — most scenic ride of my life", rating: 5, visibilityRings: [2] } },
    { id: crypto.randomUUID(), category: "travel", status: "wishlist", data: { title: "Nepal — Everest Base Camp", city: "Lukla", country: "Nepal", wishlistReason: "The ultimate trek — 12 days to the roof of the world", visibilityRings: [1, 2, 3, 4] } },
    { id: crypto.randomUUID(), category: "travel", status: "wishlist", data: { title: "Iceland Ring Road", city: "Reykjavik", country: "Iceland", wishlistReason: "Glaciers, volcanoes, northern lights, hot springs", visibilityRings: [1, 2, 3, 4] } },
  ];
}
...
async function main() {
  ...
  if (S.travelIds[0]) {
    ...
    // Rule: collaboration contributors automatically have visibility. Paris is an
    // intimate-ring trip (visibilityRings [1,2], which excludes Jason at ring 4),
    // so mirror the form's applyCollaborateChange() and union Jason into the
    // entry's visibilityContacts. This keeps the seed consistent with the
    // collaborate ⟹ visible invariant and surfaces Jason in "Who can see this".
    const { data: jasonInSarah } = await sarahClient
      .from("contacts").select("id").eq("owner_id", sarahId).eq("linked_user_id", jasonId).maybeSingle();
    const { data: parisRow } = await sarahClient.from("items").select("data").eq("id", S.travelIds[0]).single();
    if (jasonInSarah && parisRow) {
      const vc = Array.from(new Set([...(parisRow.data.visibilityContacts || []), jasonInSarah.id]));
      await sarahClient.from("items").update({ data: { ...parisRow.data, visibilityContacts: vc } }).eq("id", S.travelIds[0]);
    }
    console.log("    ✓ Sarah's Paris trip → Jason accepted with overlay + added to visibilityContacts");
  }
